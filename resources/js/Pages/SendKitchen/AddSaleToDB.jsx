...
export const AddSaleToDB = ({ products, setProduct }) => {
    ...
    const sumbitProductToDb = async (e) => {
        e.preventDefault();
        post(route("sendKitchen.store"), {
            onSuccess: () => {
                setMessage("Product Successfully Send it!");
                playSound();
    ...
    return (
        <div>
            <div className="overflow-hidden py-12 max-w-7xl mx-auto bg-white/80 px-4 sm:rounded-lg">
